...
#import os
#os.environ["CUDA_VISIBLE_DEVICES"] = "3"  #使用gpu测试
...
parser.add_argument("--weights_path",
                    type=str,
                    default="weights/Deeplabv3/xx.hdf5")
...
parser.add_argument("--val_images",
                    type=str,
                    default="data/classification_2/test_image/")
parser.add_argument("--val_annotations",
                    type=str,
                    default="data/classification_2/test_label/")
